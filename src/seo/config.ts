...
export const SEO_CONFIG = {
  ...
  languages: {
    ...
    ur: {
      ...
      hreflang: 'ur',
      name: 'اردو',
      title: 'ایم گیس | ایل پی جی سلنڈر اور صنعتی مائع گیس سلنڈرز مینوفیکچرنگ فیکٹری | M Gas Pakistan',
      description: 'کارخانہ ایم گیس (ڈائریکٹر موسیٰ عموئی - Mousa Amooie) - 50 کلو، 11.8 کلو گھریلو، 2 کلو کیمپنگ اور آٹو ایل پی جی سلنڈرز کا مصدقہ مینوفیکچرر اور پاکستان و عالمی منڈیوں کے لیے ایکسپورٹر برائے ISO 9001 اور EN 1442۔',
      keywords: 'ایل پی جی سلنڈر, گیس سلنڈر بنانے والی فیکٹری, کپسول گاز مایع, 11.8 کلو گیس سلنڈر, 50 کلو کمرشل سلنڈر, پکنک گیس سلنڈر, سیلنڈر گیس قیمت, ایم گیس, موسی عموئی, ایل پی جی سلنڈر پاکستان, LPG Cylinders Pakistan, Gas cylinder exporter, M Gas',
